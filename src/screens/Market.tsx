...
export function MarketScreen({ onNextPhase }: { onNextPhase?: () => void }) {
  ...
  const [completedWeeks, setCompletedWeeks] = useState<number[]>([7]); // W7 completed from previous phase
  ...
  const weeks = [
    ...
    { id: 9, title: 'W9: Cost', fullTitle: 'Costing & Pricing' },
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col pb-24 font-sans">
      ...
      <div className="relative z-10 max-w-3xl mx-auto w-full pt-16 px-4 flex-1">
        <div className="mb-6">
          ...
          <p className="text-blue-100 font-medium">Market</p>
        </div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4">
              ...
              {activeWeek === 8 && activeTab === 'learn' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-black text-gray-900 mb-2">Branding & Packaging</h3>
                  <p className="text-gray-600 mb-4">Designing a logo. Eco-friendly packaging choices.</p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                    <ul className="space-y-4 text-gray-700 font-medium">
                      <li className="flex gap-3"><span className="text-blue-500 font-black">1.</span> Draw and upload your Brand Logo.</li>
                      <li className="flex gap-3"><span className="text-blue-500 font-black">2.</span> Write your 1-sentence Brand Promise.</li>
                    </ul>
                  </div>
              ...
              {activeWeek === 9 && activeTab === 'learn' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-black text-gray-900 mb-2">Costing, Pricing & Marketing</h3>
                  <p className="text-gray-600 mb-4">Calculating material cost + time. Setting a profit margin (SDG 8).</p>
                  <button onClick={() => setActiveTab('do')} className="w-full bg-[#0B1F3A] text-white py-4 rounded-xl font-bold uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#15325A]">
                    Continue to Homework ➔
                  </button>
                </div>
              ...
              {activeWeek === 9 && activeTab === 'do' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                    <ul className="space-y-4 text-gray-700 font-medium">
                      <li className="flex gap-3"><span className="text-blue-500 font-black">1.</span> Submit your Final Price calculation.</li>
                    </ul>
                  </div>
                  <button onClick={() => setActiveTab('check')} className="w-full bg-[#0B1F3A] text-white py-4 rounded-xl font-bold uppercase tracking-wider hover:bg-[#15325A]">
                    Proceed to Check ➔
              ...
              {activeWeek === 10 && activeTab === 'learn' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-black text-gray-900 mb-2">Pitch Preparation</h3>
                  <p className="text-gray-600 mb-4">How to talk to customers. The 30-second elevator pitch.</p>
                  <button onClick={() => setActiveTab('do')} className="w-full bg-[#0B1F3A] text-white py-4 rounded-xl font-bold uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#15325A]">
                    Continue to Homework ➔
                  </button>
                </div>
              ...
              {activeWeek === 10 && activeTab === 'do' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                    <ul className="space-y-4 text-gray-700 font-medium">
                      <li className="flex gap-3"><span className="text-blue-500 font-black">1.</span> Record a 30-second audio/video of your pitch and upload it.</li>
                    </ul>
                  </div>
                  <button onClick={() => setActiveTab('check')} className="w-full bg-[#0B1F3A] text-white py-4 rounded-xl font-bold uppercase tracking-wider hover:bg-[#15325A]">
                    Proceed to Check ➔
              ...
              {activeTab === 'sign' && (
                <div className="space-y-6">
                  ...
                  >
                    {activeWeek === 10 ? 'Unlock Phase 5 (Graduation)' : `Submit Homework & Unlock W${activeWeek + 1}`}
                  </button>
                </div>
              )}
            </div>
